...
public class ArithmeticExpression extends Expression
{
	...
	public ArithmeticExpression(Expression opstring1, Expression opstring2, String symbol)
	{
	...
	{
		return new ArithmeticExpression(opstring1.clone(), opstring2.clone(), symbol);
	}
